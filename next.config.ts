...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://*.vercel.app https://www.google-analytics.com https://www.googletagmanager.com 'wasm-unsafe-eval';
